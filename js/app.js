...
// ══════════════════════════════════════════════════════════════════════
// MYTHOS PROD — STORAGE & SYNC ENGINE v4
// Architecture : localStorage = cache immédiat / serveur = source de vérité
// Garanties :
//   • Chaque écriture horodatée — le plus récent gagne toujours
//   • Queue persistante — aucune donnée perdue même sans réseau
//   • sendBeacon sur fermeture/arrière-plan — fonctionne sans WiFi
//   • Sync automatique au retour réseau
//   • Heartbeat 30s pour vider la queue en arrière-plan
// ══════════════════════════════════════════════════════════════════════
...
// ── Lecture locale (synchrone, cache) ────────────────────────────────
// Filet de sécurité mémoire : si localStorage est plein (quota dépassé,
...
// syncFromServer v5 est défini plus haut — cette ancienne version est supprimée.
...
let stableRepNatureRows = 0;
let calFilterMode = 'upcoming';
