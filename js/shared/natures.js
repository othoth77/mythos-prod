...
function showNatureDetail(natureId) {
  ...
  el.innerHTML = `
    <div style="margin-bottom:24px;">
      ...
      <div style="background:linear-gradient(135deg, rgba(217,164,65,0.12), rgba(217,164,65,0.06)); border:1px solid rgba(217,164,65,0.2); border-radius:16px; padding:32px 40px; margin-bottom:32px;">
        <div style="display:flex; align-items:center; gap:20px; margin-bottom:20px;">
          ...
          <div>
            <h1 style="font-family: 'Archivo Expanded', sans-serif; font-size:42px; color:var(--gold-light); font-weight:600; margin:0;">${esc(nature.nom || 'Nature')}</h1>
    ...
    ${reps.length > 0 ? `<h2 style="font-family: 'Archivo Expanded', sans-serif; color:var(--gold-light); font-size:20px; margin:32px 0 20px; border-bottom:2px solid rgba(217,164,65,0.3); padding-bottom:12px; font-weight:600;">Représentations liées (${reps.length})</h2>
    ...
    ${invs.length > 0 ? `<h2 style="font-family: 'Archivo Expanded', sans-serif; color:var(--gold-light); font-size:20px; margin:32px 0 20px; border-bottom:2px solid rgba(217,164,65,0.3); padding-bottom:12px; font-weight:600;">Factures liées (${invs.length})</h2>
