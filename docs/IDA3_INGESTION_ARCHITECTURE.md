...
**Predecessors:** [`IDAUTO_ARCHITECTURE.md`](IDAUTO_ARCHITECTURE.md) · [`IDAUTO_ROADMAP.md`](IDAUTO_ROADMAP.md) · [`MYTHOS_IDENTITY_ARCHITECTURE.md`](MYTHOS_IDENTITY_ARCHITECTURE.md) · [`IDAUTO_STORAGE_RUNBOOK.md`](IDAUTO_STORAGE_RUNBOOK.md) · [`MYTHOS_STRATEGIC_EXECUTION_REVIEW_2026-08-11.md`](MYTHOS_STRATEGIC_EXECUTION_REVIEW_2026-08-11.md)
...
Media is filesystem-first; the DB write is transactional. This is already true and already correct (`IDAUTO_STORAGE_RUNBOOK.md` §1).
...
All live-DB suites follow `IDAUTO_TEST_RUNBOOK.md`; DEVX-1 already selects the right ID Auto suites automatically for these paths.
