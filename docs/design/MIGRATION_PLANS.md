...
| **MIG-3 — still blocked on execution and mapping** | ~73 `--muted` occurrences/2 files not yet line-mapped. Still the **highest-risk remaining work in the whole program** — genuinely live production (`uthinachess.tn`) |
