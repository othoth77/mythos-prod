...
PostgreSQL is the **selected target DBMS** for IDA-2 onwards. It is not installed or deployed in IDA-0 or IDA-1. The `projects/idauto/database/schema.sql` file is a draft specification, not a deployed migration.
