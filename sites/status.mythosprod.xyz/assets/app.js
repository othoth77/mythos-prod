...
(function () {
  ...
  var AR = {
    ...
    projects: {
      ...
      'PROJECT-MYTHOS-GATEWAY': 'بوابة موحّدة أمام خوادم MCP الحالية: تجميع ووصول موثّق، دون استبدال أي خادم قائم.',
      'PROJECT-MYTHOS-ORCHESTRATOR': 'محرّك تفويض المهام: يسمح لكلود بتكليف عامل تنفيذ آخر بالعمل مع التحقق من النتيجة مقابل Git دائماً.',
      'PROJECT-MYTHOS-VAULT': 'قائمة جرد للبيانات السرّية: أين توجد كل بيانة سرية ومن يملكها، دون تخزين قيمتها هنا.',
      'PROJECT-OTH-MCP': 'واجهة قراءة محكومة للذكاء الاصطناعي: تتيح فقط ما هو مسموح، دون أي صلاحية كتابة.'
    },
    paths: {
