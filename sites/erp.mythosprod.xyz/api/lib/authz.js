...
var REQUIRE = {
  ...
  production: { GET: 'production.read', POST: 'production.write', PATCH: 'production.write', DELETE: 'production.delete' },
  ...
  inventory:  { GET: 'inventory.read',  POST: 'inventory.write',  PATCH: 'inventory.write',  DELETE: 'inventory.delete' },
