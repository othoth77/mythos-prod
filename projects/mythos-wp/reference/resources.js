...
var RESOURCES = {
  ...
  inboxes: {
    ...
    fields: [
      ...
      { name: 'account_ref', label: 'WhatsApp account (digits)', type: 'text', maxLength: 32, pattern: '^[0-9]{6,32}$', section: 'identity', help: 'Digits of the business number. A reserved (notification) account is accepted only in shared mode with the explicit personal-account opt-in.' },
