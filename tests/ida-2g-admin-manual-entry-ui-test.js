...
(async function main() {
  ...
  var ui = require(path.join(BASE, 'projects/idauto/reference/admin-ui.js'));
  ...
  var source = fs.readFileSync(path.join(BASE, 'projects/idauto/reference/admin-ui.js'), 'utf8');
