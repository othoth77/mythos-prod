...
var MIGRATION_PATH = path.join(BASE, 'projects', 'idauto', 'database', 'migrations', 'ida-3a-ingestion-schema.sql');
...
ok(migration.indexOf('IDA-3A') !== -1 && migration.indexOf('docs/IDA3_INGESTION_ARCHITECTURE.md') !== -1 && /additive-only/i.test(migration),
